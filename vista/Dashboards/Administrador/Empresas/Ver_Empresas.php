...
<style>
  ...
  .btn-add {
    position: fixed;
    top: 25px;
    background-color: #9c4012e6;  /* Café quemado */
    color: white;
    border: none;
    border-radius: 8px;
    padding: 10px 16px;
  ...
  .btn-add {
    right: 25px;
    background-color: #ff8c1a; /* Naranja */
  }
  ...
  /* 🔶 EDITAR */
  .btn-edit {
    background-color: #b25d2e; /* café claro / naranja quemado */
  ...
  /* 🔶 ELIMINAR */
  .btn-delete {
    background-color: #8b3a22; /* café rojizo */
