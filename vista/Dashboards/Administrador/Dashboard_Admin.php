    ...
    <aside class="summary-widgets">
      ...
      <div class="widget">
        ...
        <div class="widget-content">
          ...
          <button class="btn btn-confirm btn-full-width"
            onclick="window.location.href='/taquilleria_del_sol_web/vista/Dashboards/Administrador/Empresas/Ver_Empresas.php'">
